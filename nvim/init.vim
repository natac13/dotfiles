...
Plug 'junegunn/fzf', Cond(!exists('g:vscode'), { 'dir': '~/.fzf', 'do': { -> fzf#install() } })
...
if exists('g:vscode')
  ...
  nmap <leader>ac <Cmd>call VSCodeNotify('editor.action.codeAction')<CR>
  ...
  map 0 ^
  map <leader>x <Cmd>call VSCodeNotifyVisual('extension.createSnippet', 1)<CR>
    " VSCode extension
