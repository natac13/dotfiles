...
npm install coc-snippets coc-explorer coc-html coc-css coc-cfn-lint coc-tailwindcss coc-tsserver coc-json coc-graphql coc-yaml coc-pairs coc-prettier coc-eslint coc-emoji $flags
